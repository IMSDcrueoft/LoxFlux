...
typedef enum {
	...
	// Builtin Literals. 
	TOKEN_MODULE_GLOBAL, TOKEN_MODULE_MATH, TOKEN_MODULE_ARRAY, TOKEN_MODULE_OBJECT, TOKEN_MODULE_STRING, TOKEN_MODULE_TIME, TOKEN_MODULE_CTOR, TOKEN_MODULE_SYSTEM,
	// Keywords. 
