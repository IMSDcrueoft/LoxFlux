...
typedef enum {
	...
	// Builtin Literals. 
	TOKEN_MODULE_GLOBAL, TOKEN_MODULE_MATH, TOKEN_MODULE_ARRAY, TOKEN_MODULE_OBJECT, TOKEN_MODULE_STRING, TOKEN_MODULE_TIME, TOKEN_MODULE_FILE, TOKEN_MODULE_SYSTEM,
	// Keywords. 
	TOKEN_AND, TOKEN_CLASS, TOKEN_ELSE, TOKEN_FALSE,
	TOKEN_FOR, TOKEN_FUN, TOKEN_IF, TOKEN_NIL, TOKEN_OR,
	TOKEN_PRINT, TOKEN_RETURN, TOKEN_SUPER, TOKEN_THIS,
	TOKEN_TRUE, TOKEN_VAR, TOKEN_WHILE, TOKEN_CONST,
	TOKEN_BREAK, TOKEN_CONTINUE, TOKEN_COLON, TOKEN_THROW, TOKEN_LAMBDA,
	TOKEN_MATCH, TOKEN_NONE, TOKEN_INSTANCE_OF, TOKEN_TYPE_OF,
